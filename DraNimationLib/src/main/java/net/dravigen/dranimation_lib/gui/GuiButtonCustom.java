...
public class GuiButtonCustom extends GuiButton {
	...
	public void drawButton(Minecraft minecraft, int mouseX, int mouseY) {
		...
		int mouseOver = mouseX >= this.xPosition &&
								mouseY >= this.yPosition &&
								mouseX < this.xPosition + this.width &&
								mouseY < this.yPosition + this.height ? 1 : 0;
		this.drawTexturedModalRect(this.xPosition,
								   this.yPosition,
								   0,
								   mouseOver * baseTextureHeight,
								   this.width / 2,
								   this.height / 2);
		this.drawTexturedModalRect(this.xPosition + this.width / 2,
								   this.yPosition,
								   this.baseTextureWidth - this.width / 2,
								   mouseOver * baseTextureHeight,
								   this.width / 2,
								   this.height / 2);
		this.drawTexturedModalRect(this.xPosition,
								   ...
								   0,
								   this.baseTextureHeight - this.height / 2 + mouseOver * baseTextureHeight,
								   this.width / 2,
								   this.height / 2);
		this.drawTexturedModalRect(this.xPosition + this.width / 2,
								   this.yPosition + this.height / 2,
